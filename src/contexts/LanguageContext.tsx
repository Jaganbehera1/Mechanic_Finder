...
const translations = {
  en: {
    ...
    'register.profileImage': 'Profile Image URL (Optional)',
    'register.profileImagePlaceholder': 'https://example.com/your-photo.jpg',
    ...
    'register.photoRecommendation': 'Recommended: Square image, max 5MB',
    'register.supportedFormats': 'Supported formats: JPG, PNG, GIF, WebP',
    'register.skills': 'Skills & Specializations',
    'register.skillsPlaceholder': 'e.g., Furniture Making, Home Renovation',
    'register.addSkill': 'Add Skill',
    'register.socialLinks': 'Professional Links (Optional)',
    'register.website': 'Website',
    'register.websitePlaceholder': 'https://yourwebsite.com',
    'register.linkedin': 'LinkedIn',
    'register.linkedinPlaceholder': 'https://linkedin.com/in/yourprofile',
    'register.instagram': 'Instagram',
    'register.instagramPlaceholder': 'https://instagram.com/yourprofile',
  ...
  hi: {
    ...
    'card.emailVerified': 'ईमेल ✓',
    'card.phoneVerified': 'फोन ✓',
    'card.featured': 'फीचर्ड',
    'card.addToFavorites': 'पसंदीदा में जोड़ें',
    'card.removeFromFavorites': 'पसंदीदा से हटाएं',
    ...
    'register.profileImage': 'प्रोफाइल छवि URL (वैकल्पिक)',
    'register.profileImagePlaceholder': 'https://example.com/your-photo.jpg',
    'register.profilePhoto': 'प्रोफाइल फोटो',
    'register.uploadPhoto': 'फोटो अपलोड करें',
    'register.changePhoto': 'फोटो बदलें',
    'register.uploading': 'अपलोड हो रहा है...',
    'register.photoRecommendation': 'सुझाव: वर्गाकार छवि, अधिकतम 5MB',
    'register.supportedFormats': 'समर्थित प्रारूप: JPG, PNG, GIF, WebP',
    'register.skills': 'कौशल और विशेषज्ञता',
    'register.skillsPlaceholder': 'जैसे, फर्नीचर बनाना, घर का नवीनीकरण',
    'register.addSkill': 'कौशल जोड़ें',
    'register.socialLinks': 'पेशेवर लिंक (वैकल्पिक)',
    'register.website': 'वेबसाइट',
    'register.websitePlaceholder': 'https://yourwebsite.com',
    'register.linkedin': 'लिंक्डइन',
    'register.linkedinPlaceholder': 'https://linkedin.com/in/yourprofile',
    'register.instagram': 'इंस्टाग्राम',
    'register.instagramPlaceholder': 'https://instagram.com/yourprofile',
  ...
  od: {
    ...
    'card.emailVerified': 'ଇମେଲ ✓',
    'card.phoneVerified': 'ଫୋନ ✓',
    'card.featured': 'ଫିଚର୍ଡ',
    'card.addToFavorites': 'ପସନ୍ଦରେ ଯୋଗ କରନ୍ତୁ',
    'card.removeFromFavorites': 'ପସନ୍ଦରୁ ହଟାନ୍ତୁ',
    ...
    'register.profileImage': 'ପ୍ରୋଫାଇଲ ଛବି URL (ବୈକଳ୍ପିକ)',
    'register.profileImagePlaceholder': 'https://example.com/your-photo.jpg',
    'register.profilePhoto': 'ପ୍ରୋଫାଇଲ ଫଟୋ',
    'register.uploadPhoto': 'ଫଟୋ ଅପଲୋଡ କରନ୍ତୁ',
    'register.changePhoto': 'ଫଟୋ ବଦଳାନ୍ତୁ',
    'register.uploading': 'ଅପଲୋଡ ହେଉଛି...',
    'register.photoRecommendation': 'ସୁପାରିଶ: ବର୍ଗାକାର ଛବି, ସର୍ବାଧିକ 5MB',
    'register.supportedFormats': 'ସମର୍ଥିତ ଫର୍ମାଟ: JPG, PNG, GIF, WebP',
    'register.skills': 'କୌଶଳ ଏବଂ ବିଶେଷଜ୍ଞତା',
    'register.skillsPlaceholder': 'ଯେପରି, ଆସବାବପତ୍ର ତିଆରି, ଘର ନବୀକରଣ',
    'register.addSkill': 'କୌଶଳ ଯୋଗ କରନ୍ତୁ',
    'register.socialLinks': 'ପେଶାଦାର ଲିଙ୍କ (ବୈକଳ୍ପିକ)',
    'register.website': 'ୱେବସାଇଟ',
    'register.websitePlaceholder': 'https://yourwebsite.com',
    'register.linkedin': 'ଲିଙ୍କଡଇନ',
    'register.linkedinPlaceholder': 'https://linkedin.com/in/yourprofile',
    'register.instagram': 'ଇନଷ୍ଟାଗ୍ରାମ',
    'register.instagramPlaceholder': 'https://instagram.com/yourprofile',
